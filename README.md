...
```bash
npm install -g @stdlib/assert-is-alphanumeric
```
...
[test-image]: https://github.com/stdlib-js/assert-is-alphanumeric/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-is-alphanumeric/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/assert-is-alphanumeric
